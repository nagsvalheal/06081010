...
export default class BiPspbHcpEnrollment extends LightningElement {
  ...
  handleFirstNameChangeOne(value) {
    ...
    if (this.leadFields.FirstName === "") {
      ...
      !this.validateFirstNamePattern().test(this.leadFields.FirstName)
    ) {
  ...
  handleLastNameChangeOne(value) {
    ...
    if (this.leadFields.LastName === "") {
      ...
      !this.validateFirstNamePattern().test(this.leadFields.LastName)
    ) {
  ...
  FirstNameTextErr() {
    const FIRST_NAME_FIELD = this.template.querySelector(
      'lightning-input[data-field="hFN"]'
    );
    FIRST_NAME_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hFN"]').className =
      "input-error-label";
  }
  FirstNameText() {
    const FIRST_NAME_FIELD = this.template.querySelector(
  ...
  handleFirstNameChange(value) {
    ...
    if (this.hcpFields.firstname === "") {
      ...
      !this.validateFirstNamePattern().test(this.hcpFields.firstname)
    ) {
      this.FirstNameTextErr();
  ...
  LastNameErr() {
    const LAST_NAME_FIELD = this.template.querySelector(
      'lightning-input[data-field="hLN"]'
    );
    LAST_NAME_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hLN"]').className =
      "input-error-label";
  }
  LastNameText() {
    const LAST_NAME_FIELD = this.template.querySelector(
  ...
  PracticeNameErr() {
    const PRACTICE_NAME = this.template.querySelector(
      'lightning-input[data-field="hPN"]'
    );
    PRACTICE_NAME.className = "textInput-err";
    this.template.querySelector('div[data-field="hPN"]').className =
      "input-error-label";
  }
  PracticeName() {
    const PRACTICE_NAME = this.template.querySelector(
  ...
  handlePracticeNameChange(value) {
    ...
    if (this.hcpFields.PRACTICE_NAME === "") {
      ...
      !this.validateFirstNamePattern().test(this.hcpFields.PRACTICE_NAME)
    ) {
  ...
  LicenseNumberErr() {
    const LICENSE_FIELD = this.template.querySelector(
      'lightning-input[data-field="hLicense"]'
    );
    LICENSE_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hLicense"]').className =
      "input-error-label";
  }
  LicenseNumber() {
    const LICENSE_FIELD = this.template.querySelector(
  ...
  PracticeFieldErr() {
    const PRACTICE_FIELD = this.template.querySelector(
      'lightning-combobox[data-field="hType"]'
    );
    PRACTICE_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hType"]').className =
      "input-error-label";
  }
  PracticeField() {
    const PRACTICE_FIELD = this.template.querySelector(
  ...
  EmailFieldErr() {
    const EMAIL_FIELD = this.template.querySelector(
      'lightning-input[data-field="hEmail"]'
    );
    EMAIL_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hEmail"]').className =
      "input-error-label";
  }
  EmailField() {
    const EMAIL_FIELD = this.template.querySelector(
  ...
  PhoneFieldErr() {
    const PHONE_FIELD = this.template.querySelector(
      'lightning-input[data-field="hPhone"]'
    );
    PHONE_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hPhone"]').className =
      "input-error-label";
  }
  PhoneField() {
    const PHONE_FIELD = this.template.querySelector(
  ...
  FaxFieldErr() {
    const FAX_FIELD = this.template.querySelector(
      'lightning-input[data-field="hFax"]'
    );
    FAX_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hFax"]').className =
      "input-error-label";
  }
  FaxField() {
    const FAX_FIELD = this.template.querySelector(
  ...
  CountryFieldErr() {
    ...
    this.template.querySelector('div[data-field="hcc"]').className =
      "input-error-label";
  }
  CountryField() {
    const MAILING_COUNTRY_CODE_FIELD = this.template.querySelector(
  ...
  handleStateCodeChange(value) {
    ...
    const MAILING_STATE_CODE_FIELD = this.template.querySelector(
      'lightning-combobox[data-field="hsc"]'
    );
    if (!this.selectedstate) {
      this.rpStateCodeErrorMessage = false;
      MAILING_STATE_CODE_FIELD.className = "textInput";
      this.template.querySelector('div[data-field="hsc"]').className =
        "input-label";
    }
  }
  CityFieldErr() {
    const CITY_FIELD = this.template.querySelector(
      'lightning-input[data-field="hc"]'
    );
    CITY_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hc"]').className =
      "input-error-label";
  }
  CityField() {
    const CITY_FIELD = this.template.querySelector(
  ...
  StreetFieldErr() {
    const MAILING_STREET_FIELD = this.template.querySelector(
      'lightning-textarea[data-field="hs"]'
    );
    MAILING_STREET_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="hs"]').className =
      "input-error-label";
  }
  StreetField() {
    const MAILING_STREET_FIELD = this.template.querySelector(
  ...
  PinCodeErr() {
    const ZIP_CODE = this.template.querySelector(
      'lightning-input[data-field="hpc"]'
    );
    ZIP_CODE.className = "textInput-err";
    this.template.querySelector('div[data-field="hpc"]').className =
      "input-error-label";
  }
  PinCode() {
    const ZIP_CODE = this.template.querySelector(
  ...
  handleInputChangeCaregiver(event) {
    ...
    this.dispatchCaregiverFieldChange(
      FIELD_NAME_CAREGIVER,
      TARGET_VALUE_CAREGIVER,
      event
    );
  }
  ...
  CaregiverFnameErr() {
    this.template.querySelector("lightning-input.cFN").className =
      "textInput-err cFN";
    this.template.querySelector("div.cFN").className =
  ...
  handleCaregiverFirstNameChange(value) {
    ...
    if (this.caregiverFields.FirstName === "") {
      ...
      !this.validateFirstNamePattern().test(this.caregiverFields.FirstName)
    ) {
  ...
  CaregiverLnameErr() {
    this.template.querySelector("lightning-input.cLN").className =
      "textInput-err cLN";
    this.template.querySelector("div.cLN").className =
  ...
  handleCaregiverLastNameChange(value) {
    ...
    if (this.caregiverFields.LastName === "") {
      ...
      !this.validateFirstNamePattern().test(this.caregiverFields.LastName)
    ) {
  ...
  CaregiverEmailErr() {
    ...
    this.template.querySelector("div.cEmail").className =
  ...
  CaregiverPhoneErr() {
    ...
    PHONE_FIELD.className = "textInput-err";
    this.template.querySelector('div[data-field="cPhone"]').className =
      "input-error-label";
  }
  CaregiverPhone() {
    const PHONE_FIELD = this.template.querySelector(
  ...
  CaregiverRelationErr() {
    this.template.querySelector("lightning-combobox.cRel").className =
      "textInput-err cRel";
    this.template.querySelector("div.cRel").className =
      ...
      PRODUCT_LIST()
        ...
        .then((result) => {
          if (result !== null && result.length > 0) {
            ...
            this.picklistOrdered = this.picklistOrdered.toSorted((a, b) => {
              if (a.label < b.label) {
                return -1;
        ...
        .then((result) => {
          ...
          if (result.length > 0) {
            ...
            if (picklistOrderedOne.length > 0) {
              this.picklistOrderedOne = picklistOrderedOne.toSorted((a, b) =>
                a.label.localeCompare(b.label)
              );
            }

            if (picklistOrderedTwo.length > 0) {
              this.picklistOrderedTwo = picklistOrderedTwo.toSorted((a, b) =>
                a.label.localeCompare(b.label)
              );
            }
          }
  ...
  setFieldErrorStyles() {
    ...
    this.template.querySelector('div[data-field="pdob"]').className =
      "input-error-label";
  }
  ...
  patientvalidateForm() {
    ...
    const fieldsToValidate = [
      resource.FIRSTNAME_VALUE,
      resource.LASTNAME_VALUE,
      resource.DOB_VALUE,
      resource.GENDER_VALUE,
      resource.EMAIL,
      resource.PHONE_VALUE
    ];
  ...
  HCPvalidateForm() {
    ...
    isValid =
      this.validateComboBoxField("hcc", "RPcountryerrorMessage") && isValid;
    isValid =
      this.validateComboBoxField("hsc", "rpStateCodeErrorMessage") && isValid;
  ...
  validateComboBoxField(dataField, errorMessageFlag) {
    const field = this.template.querySelector(
      `lightning-combobox[data-field="${dataField}"]`
    );
    if (!field.value) {
    ...
    this.template.querySelector(`div[data-field="${dataField}"]`).className =
      "input-label";
    return true;
  }
  ...
  UniquecaregiverValidation() {
    ...
    if (
        ...
        isValid = true;
    } else if (this.uniqueEmail.includes(this.caregiverFields.Email)) {
