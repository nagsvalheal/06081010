...
export default class BiPspbDlqiQuestionnaire extends LightningElement {
	...
	*/
	...
	submitResponses() {
		...
		else if (allInputs.length === 10 && seventhQuestionChecked.value !== 'Yes') {
			this.customFormModal = false;
			this.isPopupOpen1 = false;
			this.isPopupOpen = true;

		}
		else if (allInputs.length === 10 && seventhQuestionChecked.value === 'Yes' && isEighthQuestionChecked === false) {
			this.customFormModal = true;
			this.isPopupOpen1 = true;
			this.isPopupOpen = false;
		}
		else if (allInputs.length === 10 && seventhQuestionChecked.value === 'Yes' && isEighthQuestionChecked === true) {
			this.customFormModal = false;
			this.isPopupOpen1 = false;
			this.isPopupOpen = true;
		}
